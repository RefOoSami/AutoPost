...
#GOOGLE_REDIRECT_URI = os.environ.get('GOOGLE_REDIRECT_URI', "https://finalscore.onrender.com/auth/oauth2callback")
GOOGLE_REDIRECT_URI = os.environ.get('GOOGLE_REDIRECT_URI', "https://autopost-374c.onrender.com//auth/oauth2callback")
